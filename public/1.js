...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread({
    like: function like() {
      ...
      if (this.liked === false) {
        this.registrarLike(this.id).then(function () {
          return _this.likes++;
        })["catch"](function (err) {
  ...
  }, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])(["registrarLike", "removerLike", "asignarDatosToast"])),
  ...
  return _c(
    "a",
    {
      attrs: {
        ...
        "data-toggle": "tooltip",
        "data-placement": "top",
        title: _vm.comprobarMeGusta.title
      },
      on: {
