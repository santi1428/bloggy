...
// module
exports.push([module.i, "\n#contenedor[data-v-63cd6604]{\n    font-family: 'Nunito', sans-serif;\n    overflow-x: hidden;\n}\n.encabezado[data-v-63cd6604]{\n    height: 91vh;\n}\n#texto-encabezado[data-v-63cd6604], .box p[data-v-63cd6604]{\n    font-size: 1.2rem;\n}\n#texto-bloggy[data-v-63cd6604]{\n    font-size: 1.6rem;\n    color:#616970\n}\n.box[data-v-63cd6604]{\n    border: 1px solid#c8d4d5;\n    border-radius: 8px;\n    text-align: justify;\n    transition: 0.3s;\n}\n.box[data-v-63cd6604]:hover{\n    transition: 0.3s;\n    color: #ffff;\n    border: 1px solid #2d5b5e;\n    background: #2d5b5e;\n}\n#boton-publicaciones[data-v-63cd6604]{\n    text-decoration: none;\n    color: #ffff;\n    background: #2d5b5e; \n    padding: 10px 27px;       \n    border-radius: 15px;\n    font-size: 1.1rem;\n    transition: 0.3s;\n}\n#boton-publicaciones[data-v-63cd6604]:hover{\n    background: #285154;\n    color: #e5e5e5;\n    font-size: 18px;\n    transition: 0.3s;\n}\n\n", ""]);
...
var render = function() {
  ...
  return _c("div", { attrs: { id: "contenedor" } }, [
    _c("title", [_vm._v("Inicio")]),
    _vm._v(" "),
    _c("div", { staticClass: "row encabezado" }, [
      _c("div", { staticClass: "col-12" }, [
        _c("h1", { staticClass: "display-4 mt-3 text-center text-secondary" }, [
          _vm._v("Bienvenido a la web del blogger")
        ]),
        _vm._v(" "),
        _c(
          "p",
          {
            staticClass: "text-center my-3 my-sm-0",
            attrs: { id: "texto-encabezado" }
          },
          [
            _vm._v(
              "Si eres un blogger o te gusta mucho compartir tus ideas o experiencias de tu vida, llegaste al sitio indicado"
            )
          ]
        ),
        _vm._v(" "),
        _c(
          "div",
          { staticClass: "text-center mt-4 mt-sm-3" },
          [
            _c(
              "router-link",
              { attrs: { to: { name: "Posts" }, id: "boton-publicaciones" } },
              [_vm._v("Ir a las publicaciones")]
            )
          ],
          1
        ),
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-md-3 text-center ml-lg-5" }, [
        _c("p", { attrs: { id: "texto-bloggy" } }, [
          _vm._v("En Bloggy puedes: ")
        ])
      ])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "row justify-content-around" }, [
      _c(
        ...
        {
          staticClass:
            "col-11 col-sm-3 text-center box pt-3 px-4 animated zoomIn"
        },
        [
          _c("i", { staticClass: "fas fa-pencil-alt fa-7x text-success" }),
          _vm._v(" "),
          _c("h3", { staticClass: "mt-3" }, [
            _vm._v("Publicar y compartir tus experiencias")
          ]),
          _vm._v(" "),
          _c("p", [
            _vm._v(
      ...
      _c(
        ...
        [
          _c("i", { staticClass: "fas fa-thumbs-up fa-7x text-primary" }),
          _vm._v(" "),
          _c("h3", { staticClass: "mt-3" }, [
            _vm._v("Dar like a tus publicaciones favoritas")
          ]),
          _vm._v(" "),
          _c("p", [
            _vm._v(
      ...
      _c(
        ...
        [
          _c("i", { staticClass: "fas fa-comments fa-7x text-info" }),
          _vm._v(" "),
          _c("h3", { staticClass: "mt-3" }, [
            _vm._v("Comentar tus opiniones en los comentarios")
          ]),
          _vm._v(" "),
          _c("p", [
            _vm._v(
