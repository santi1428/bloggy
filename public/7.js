      ...
      if (regex.test(this.comment.comment) == false && this.comment.comment != "") {
        ...
        this.comentar(this.comment).then(function (res) {
          if (res.status == 200) {
            ...
            _this.$emit('aumentar-comentarios');
          }
        })["catch"](function (err) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_4__["mapActions"])(["traerPublicacion", "traerComentarios", "eliminarComentario"]), {
    ...
    borrarComentario: function borrarComentario(commentId) {
      var _this = this;

      this.eliminarComentario(commentId).then(function () {
        _this.post.comments_amount--;
      })["catch"](function (err) {
        return console.log(err);
      });
    }
  }),
  computed: Object(vuex__WEBPACK_IMPORTED_MODULE_4__["mapGetters"])(["getComments", "getMostrarAnimacionEliminarDeComentarioId", "getUserId", "loggedIn"]),
  created: function created() {
    ...
    this.traerPublicacion(this.$route.params.id).then(function (post) {
      ...
      _this2.traerComentarios(_this2.post.id).then(function (res) {
        return console.log(_this2.getComments);
      })["catch"](function (err) {
        return console.log(err);
      });
    })["catch"](function (err) {
                ...
                [
                  ...
                  _c("div", { staticClass: "row" }, [
                    _c("div", { staticClass: "col-auto" }, [
                      _c("img", {
                        attrs: {
                          src: "/storage/profile_images/" + _vm.post.userImage,
                        ...
                        _c(
                          ...
                          [
                            _c("like", {
                              attrs: {
                                id: _vm.post.id,
                                likes_amount: _vm.post.likes_amount
                              }
                            })
                          ],
                          1
                  ...
                  _c("div", { staticClass: "row justify-content-center" }, [
                    _c("div", { staticClass: "col" }, [
                      _c("h5", [
                        _vm._v("Comentarios"),
                        _c("span", { staticClass: "badge badge-info ml-2" }, [
                          _vm._v(_vm._s(_vm.post.comments_amount))
                        ])
                      ])
                    ])
                  ]),
                  ...
                  _vm.loggedIn
                    ? _c("comentar", {
                        ...
                        on: {
                          "aumentar-comentarios": function($event) {
                            _vm.post.comments_amount++
                          }
                        }
                      })
                    : _c("div", { staticClass: "row" }, [
                        _c(
                          "div",
                          {
                            staticClass: "col-sm-10 col-md-8 col-lg-6 col-xl-5"
                          },
                          [
                            _c(
                              "div",
                              ...
                              [
                                ...
                                _vm._v(
                                  "si no tienes cuenta para comentar o dar like\n                                        "
                                ),
                                _c(
                                  "button",
                                  {
                        ...
                        [
                          ...
                          _c("div", { staticClass: "col" }, [
                            _c("div", { staticClass: "row" }, [
                              ...
                              _vm._v(" "),
                              _vm.post.userId === parseInt(_vm.getUserId) ||
                              comment.userId === parseInt(_vm.getUserId)
                                ? _c(
                                    "div",
