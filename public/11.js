...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread({
    ...
    removerPublicacion: function removerPublicacion(id) {
      ...
      this.eliminarPublicacion(id).then(function (res) {
        ...
        _this.asignarMensajeToast("Se ha eliminado la publicación"); //  $('#toast').toast('show');
  ...
  }, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])(["eliminarPublicacion"]), {}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapMutations"])(["ocultarModalEliminar", "asignarMensajeToast"])),
